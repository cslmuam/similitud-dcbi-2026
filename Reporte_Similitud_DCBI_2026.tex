...
\fancyhead[L]{\small\color{uamgray}División CBI · UAM-Azcapotzalco}
...
El proceso de modificación curricular 2026 de la División CBI implica la revisión simultánea de 773 programas de Unidades de Enseñanza-Aprendizaje (UEA) distribuidos en las diez licenciaturas de la División.
Una de las tareas centrales es identificar si distintos programas de diferentes licenciaturas cubren contenido equivalente o sustancialmente solapado---información indispensable tanto para proponer unificaciones al Tronco General como para detectar duplicaciones implícitas entre planes de estudio que se ofrecen de manera independiente.
...
Las figuras interactivas (\texttt{*.html} en la carpeta \texttt{Figuras/}) permiten identificar UEAs individuales al pasar el cursor.
...
Es de facto una UEA del Tronco General sin serlo formalmente.
\end{hallazgo}
...
Candidata a elevarse a Tronco General o a coordinación institucional explícita.
\end{hallazgo}
...
\textbf{3. Revisión del estatus de Ecuaciones Diferenciales y Liderazgo y Emprendimiento como Tronco General implícito (H5, H6).}
Ambas UEAs tienen presencia en 9 de 10 planes con contenido prácticamente idéntico---equivalente al Tronco General formal---pero no están clasificadas como tal.
Se recomienda un análisis institucional que determine si procede su incorporación explícita al Tronco General o la adopción de un mecanismo de coordinación equivalente.
